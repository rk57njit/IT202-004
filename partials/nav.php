        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">             
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-warning" aria-labelledby="rolesDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/all_orders.php'); ?>">All Orders</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="rolesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo get_url('showUsers.php'); ?>">Users</a></li>
